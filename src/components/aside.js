                ...
                <div className="w-full h-full flex flex-col justify-between">
                    <nav className={`${menu ? "w-2/4 lg:w-full p-0" : "w-0 lg:w-full p-0"} flex flex-col justify-between absolute top-0 pt-[96px] z-50 left-0 lg:relative transition-all duration-150 bg-sky-500 mx-auto lg:block  lg:p-0 lg:bg-transparent h-screen lg:h-auto`}>
                        <ul className={`${menu ? "flex" : "hidden lg:flex"} flex-col gap-2 list-none w-full`}>
                            ...
                            <li className="li-nav-aside">
                                <a
                                    className={`flex ${menu ? 'justify-start' : 'justify-center'} transition-all duration-100 items-start gap-1 text-black no-underline py-3 px-6 text-sm 2xl:text-base ${pathname == "/lotes" ? "bg-white hover:bg-white" : "hover:bg-sky-600 text-white"
                                        }`}
                                    href={"/lotes"}
                                >
                            ...
                            <li className="li-nav-aside">
                                <a className={`flex ${menu ? 'justify-start' : 'justify-center'} transition-all duration-100 items-center gap-1 text-black no-underline py-3 px-6 text-sm 2xl:text-base ${pathname == "/compras" ? "bg-white hover:bg-white" : "hover:bg-sky-600 text-white"
                                    }`}
                                    href={"/compras"}
                                >
                                    <div><QrCode size={20} color={pathname == '/compras' ? "#0ea5e9" : 'white'} /></div><div className={`${menu ? "block font-semibold" : "hidden"} line-clamp-1`}>Compras / Ventas</div>
                                </a>
                            </li>
                            <li className="li-nav-aside">
                                <a
                                    className={`flex ${menu ? 'justify-start' : 'justify-center'} transition-all duration-100 items-center gap-1 text-black no-underline py-3 px-6 text-sm 2xl:text-base ${pathname == "/configuracion" ? "bg-white hover:bg-white" : "hover:bg-sky-600 text-white"
                                        }`}
                                    href={"/configuracion"}
                                >
